...
// CHANGE THESE to your home WiFi. This is the only WiFi config needed -
// there is no setup AP / captive portal. The device connects directly on
// every boot; find its IP from the Serial Monitor (or your router) and
// use that to reach the dashboard.
#define WIFI_SSID       "Airtel_2.4GHz"
